...
export default {
   ...
   created() {
      ...
      this.username = JSON.parse(localStorage.getItem('xm-user')).username
      this.userid = JSON.parse(localStorage.getItem('xm-user')).id
   ...
   methods: {
      webSocketInit(){
         const webSocketUrl = 'ws://localhost:9090/websocket/'+this.username
