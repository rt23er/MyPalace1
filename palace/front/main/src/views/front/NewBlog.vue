        ...
        <div class="card" style="margin-bottom: 100px">
            ...
            <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
                ...
                <el-form-item label="标签" prop="tags">
                    <el-select v-model="tagsArr" style="width: 100%">
                        <el-option v-for="item in LabelList" :key="item.id" :value="item.id"
                                   :label="item.name"></el-option>
                    </el-select>
                </el-form-item>
            ...
            <div style="text-align: center">
                <el-button type="primary" size="medium" style="width: 100px" @click="save">发布</el-button>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    mounted() {
        ...
        this.$request.get('/label/selectAll').then(res => {
