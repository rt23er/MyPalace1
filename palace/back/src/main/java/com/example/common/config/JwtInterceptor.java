...
// 使用正则表达式进行匹配
            ...
            boolean matches6 = Pattern.matches(pattern6, url);
            boolean matches7 = Pattern.matches(pattern7, url);
            if(matches||url.equals("/doc.html")
                    ||matches2||matches3||matches4||matches5||matches6||matches7){
                return true;
            }
